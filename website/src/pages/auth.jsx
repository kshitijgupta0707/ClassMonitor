...
const Auth = () => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-t from-[#141e30] to-[#243b55]">
      <div className="w-[400px] h-[600px] overflow-hidden bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#24243e] shadow-2xl rounded-lg">
        <form
