  ...
  if (loading) {
    return (
      <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#24243e] text-white font-sans">
        <div className="w-[400px] h-[600px] bg-gradient-to-b from-[#1e1e2f] via-[#302b63] to-[#24243e] shadow-lg flex flex-col overflow-hidden rounded-lg">
          ...
          <div className="w-[400px] h-[600px] bg-gradient-to-b from-[#1e1e2f] via-[#302b63] to-[#24243e] shadow-lg flex flex-col overflow-hidden rounded-lg">
            ...
            <div className="flex-1 p-5 overflow-y-auto space-y-5">
              {courses.map((course, index) => (
                <div
                  key={index}
                  className="h-12 flex items-center px-4 bg-[#302b63] rounded-lg text-white shadow-md transition-transform duration-300 transform hover:scale-105 hover:bg-[#bfad45] hover:text-black cursor-pointer"
                  onClick={() => {
