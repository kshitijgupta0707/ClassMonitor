...
const Lecture = () => {
  ...
  const handleViewPdf = (lecture) => {
    setViewingPdf(lecture);
    setShowOptionsMenu(null);
  };
  ...
  const OptionsMenu = ({ index, url, lectureId, lecture }) => {
  ...
  return (
    <div className="flex justify-center items-center min-h-screen bg-gradient-to-b from-[#0f0c29] via-[#302b63] to-[#24243e] text-white">
      <div className="w-full max-w-6xl px-4">
        <div className="min-h-[600px] bg-[#24243e] shadow-lg overflow-hidden flex flex-col rounded-lg">
      ...
      {/* PDF Viewer - Using PdfViewer Component */}
      {viewingPdf && (
        <PdfViewer lecture={viewingPdf} onClose={closePdfViewer} />
      )}
    </div>
  );
};
